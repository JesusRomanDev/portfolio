...
function Heading() {
  ...
  return (
    <>
      <section id='home' className='z-30 fixed top-0 sm:flex sm:flex-col py-4 md:grid md:grid-cols-2 gap-x-2 w-screen bg-slate-600'>
        <div className='flex justify-evenly'>
          <Link to='home' offset={-10} onClick={topPage} className='cursor-pointer flex items-center'><svg xmlns="http://www.w3.org/2000/svg" className="hover:scale-150 hover:duration-300 ease-out duration-300 icon-tabler icon-tabler-code" width="36" height="36"         viewBox="0 0 24 24" strokeWidth="1.5" stroke="#f6f6f6" fill="none" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className='flex justify-center place-items-center'>
          <nav className='grid grid-cols-2 sm:flex sm:flex-row relative overflow-hidden gap-x-6 sm:gap-x-4 p-3 text-white'>
            ...
            <Link to="about" spy={true} smooth={true} hashSpy={true} offset={0} duration={500} activeClass='colores' className='navCustom'>About me</Link>

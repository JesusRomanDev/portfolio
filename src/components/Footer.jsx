                ...
                <div className='flex justify-evenly'>
                    ...
                    <div className='flex-col gap-5 font-bold text-white'>
                        ...
                        <div className='flex items-center justify-center gap-5 mt-5'>
                            ...
                            <div className='flex items-center border-2 rounded'><p className='email px-2'>jesus.romanv@outlook.com</p><svg onClick={copy} className='cursor-pointer' xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-copy" width="22" height="36" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>

...
const Footer = () => {
  ...
  return (
    <>
        <footer id='contact' className=' p-4 h-10% w-auto left-0 flex justify-evenly bottom-0'>
                ...
                <div className='flex justify-evenly max-w-full'>
                    ...
                    <div className='max-w-full flex-col gap-5 font-bold text-white'>
                        ...
                        <div className='flex flex-col md:flex-row items-center justify-center gap-5 mt-5'>
                            ...
                            <div className='max-w-full flex flex-wrap justify-center items-center border-2 rounded'>
